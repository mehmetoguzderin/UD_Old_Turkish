...
Feature assignment to transliterations is only figurative, and the exact realization of sounds is out of this document's scope.
...
Occlusive representations are primary for duplicates across different manners, and fricatives only exist for ergonomics.
