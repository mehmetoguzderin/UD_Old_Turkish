= UDW21 Old Turkish and Old Turkic

2021 Workshop on Universal Dependencies Old Turkish Language and Old Turkic Script
...
Alternatively, it is possible to use the following concise ASCII notation by not recognizing <<consonants,ergonomic duplicate fricative consonants>>. In long vowels, the letter a can substitute the second letter h for sort purposes, in which case, h can represent further consonantal sound correspondence. Repetition, doubling of any phonemic quality neutralizing separators, such as the blank space, dash, or underscore, can map to punctuation depending on the interpretation mode. Both modes have the same set of changes for the representation of round vowels.
